# taken from https://github.com/Efficient-Large-Model/VILA/blob/main/llava/eval/eval_mmvet.py
# actually modified froim https://github.com/yuweihao/MM-Vet/blob/main/mm-vet_evaluator.ipynb
