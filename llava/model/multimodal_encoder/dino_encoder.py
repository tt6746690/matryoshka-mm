...
class DINOVisionTower(nn.Module):
    ...
    def load_model(self, device_map=None):
        ...
        # https://huggingface.co/facebook/dinov2-base/discussions/9#:~:text=From%20what%20I%20know%2C%20DINOv2,tuned%20at%20224x224%20on%20ImageNet.
        self.image_processor = AutoImageProcessor.from_pretrained(self.vision_tower_name)
        self.vision_tower = AutoModel.from_pretrained(self.vision_tower_name, device_map=device_map)
        self.vision_tower.requires_grad_(False)

        # modify the config so that image_size matches with imageprocessor crop -> 224
